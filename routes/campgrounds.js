...
router
  ...
  .post(
    ...
    validateCampground,
    parser.array("image"),
    catchAsync(campCtrl.postNewCamp)
  );
...
router
  ...
  .delete(
    isAuthenticated,
    isAuthorCampground,
    catchAsync(campCtrl.deleteOneCamp)
  )
  .put(validateCampground, isAuthorCampground, catchAsync(campCtrl.putEditOne));

router.get(
  "/:id/edit",
  isAuthenticated,
  isAuthorCampground,
  catchAsync(campCtrl.getEditForm)
);
